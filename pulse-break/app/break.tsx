...
const styles = StyleSheet.create({
  ...
  tierBadgeText: { fontSize: 11, color: COLORS.white, fontFamily: FONTS.semibold },
  scroll: { flex: 1, backgroundColor: COLORS.cream },
  scrollContent: { paddingHorizontal: 24, paddingTop: 24, paddingBottom: 48 },
  header: { fontSize: 28, fontFamily: FONTS.bold, color: COLORS.ink, lineHeight: 36, marginBottom: 24 },
  ...
  tierText: { flex: 1 },
  tierName: { fontSize: 14, fontFamily: FONTS.semibold, color: COLORS.ink },
  ...
  infoValue: { fontSize: 16, fontFamily: FONTS.bold, color: COLORS.ink },
  ...
  breathingTitle: { fontSize: 16, fontFamily: FONTS.bold, color: COLORS.ink, marginBottom: 4 },
  ...
  breathPhaseLabel: { fontSize: 22, fontFamily: FONTS.bold },
  ...
  timerLabel: { fontSize: 11, color: COLORS.inkSoft, fontFamily: FONTS.semibold, textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 8 },
  timerValue: { fontSize: 52, fontFamily: FONTS.bold, lineHeight: 60 },
  ...
  disconnectTitle: { fontSize: 18, fontFamily: FONTS.bold, color: COLORS.coral, marginBottom: 4 },
