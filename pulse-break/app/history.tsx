...
import { getWeeklyCheckIns, CheckIn } from '../utils/storage';
  ...
  const renderItem = ({ item }: { item: CheckIn }) => (
    <View style={styles.card}>
      ...
      <View style={styles.cardMiddle}>
        <Text style={[styles.cardLabel, { color: LEVEL_COLOR[item.stressLevel] }]}>
          {LABEL_MAP[item.stressLevel]}
        </Text>
